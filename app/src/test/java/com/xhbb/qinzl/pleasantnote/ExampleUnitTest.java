...
//                lyrics.indexOf("]",
//                        lyrics.indexOf("[offset"))
//                        + 1).trim();
//
//        lyrics = lyrics.replaceAll("\\[(\\d{2,}):[0-5]\\d\\.\\d{2}\\]", "");
//
//        System.out.println(lyrics);
//        (int) (((double) downloadedLength / contentLength) * 100);

        System.out.println((int) (((double) 43435 / 343345) * 100));
